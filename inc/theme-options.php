...
function less_options_page_html() {
    ...
    $defaults = array(
        ...
        'qr_code_url'            => 'https://88.ai888.uk/wp-content/uploads/2025/12/11.jpg',
        'wechat_pay_qr'          => '',
        'alipay_qr'              => '',
    );
        ...
        <form action="options.php" method="post">
            ...
            <div style="<?php echo $active_tab == 'general' ? '' : 'display:none;'; ?>">
                ...
                <table class="form-table">
                    ...
                    <tr valign="top">
                        <th scope="row">公众号二维码</th>
                        <td>
                            <input type="text" name="less_options[qr_code_url]" id="qr_code_url" value="<?php echo isset($options['qr_code_url']) ? esc_attr($options['qr_code_url']) : ''; ?>" class="regular-text">
                            <input type="button" class="button button-secondary js-upload-image" data-target="#qr_code_url" value="上传二维码">
                            <p class="description">上传或选择公众号二维码图片。</p>
                            <?php if ( ! empty( $options['qr_code_url'] ) ) : ?>
                                <div class="less-image-preview" style="margin-top:10px;"><img src="<?php echo esc_url($options['qr_code_url']); ?>" style="max-height: 128px;"></div>
                            <?php endif; ?>
                        </td>
                    </tr>
                    <tr valign="top">
                        <th scope="row">微信收款码</th>
                        <td>
                            <input type="text" name="less_options[wechat_pay_qr]" id="wechat_pay_qr" value="<?php echo isset($options['wechat_pay_qr']) ? esc_attr($options['wechat_pay_qr']) : ''; ?>" class="regular-text">
                            <input type="button" class="button button-secondary js-upload-image" data-target="#wechat_pay_qr" value="上传收款码">
                            <p class="description">上传微信收款码，用于付费内容。</p>
                            <?php if ( ! empty( $options['wechat_pay_qr'] ) ) : ?>
                                <div class="less-image-preview" style="margin-top:10px;"><img src="<?php echo esc_url($options['wechat_pay_qr']); ?>" style="max-height: 128px;"></div>
                            <?php endif; ?>
                        </td>
                    </tr>
                    <tr valign="top">
                        <th scope="row">支付宝收款码</th>
                        <td>
                            <input type="text" name="less_options[alipay_qr]" id="alipay_qr" value="<?php echo isset($options['alipay_qr']) ? esc_attr($options['alipay_qr']) : ''; ?>" class="regular-text">
                            <input type="button" class="button button-secondary js-upload-image" data-target="#alipay_qr" value="上传收款码">
                            <p class="description">上传支付宝收款码，用于付费内容。</p>
                            <?php if ( ! empty( $options['alipay_qr'] ) ) : ?>
                                <div class="less-image-preview" style="margin-top:10px;"><img src="<?php echo esc_url($options['alipay_qr']); ?>" style="max-height: 128px;"></div>
                            <?php endif; ?>
                        </td>
                    </tr>
                </table>
